...
const DemoBooleanComponent = (props: Props) => {
...
DemoBooleanComponent.propTypes = {
  propName: PropTypes.string.isRequired,
  className: PropTypes.string,
};

DemoBooleanComponent.defaultProps = {
  className: null,
};

export default DemoBooleanComponent;
